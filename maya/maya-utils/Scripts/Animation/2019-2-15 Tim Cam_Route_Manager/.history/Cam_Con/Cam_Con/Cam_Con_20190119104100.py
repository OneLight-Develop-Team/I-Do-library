...
class Cam_Con(form_class,base_class):
    ...
    def Get_Constraint_Fn(self):
        ...
        constraintNode = cmds.listConnections(selection,type="constraint",p=1)[0]
        print constraintNode
        AttrList = cmds.listAttr( constraintNode,r=1, s=1,k=1, string="*W")
        constraintList = cmds.listConnections(constraintNode)
