...
class Cam_Main(form_class,base_class):
    def __init__(self,dock="dock"):
        ...
        Cam_Item = Cam_Item_Layout()
        Cam_Attrubte = Cam_Attrubte_Panel()
        self.splitter = QSplitter(self.Main_Layout.layout())
        self.splitter.setHandleWidth(5)
        self.splitter.addWidget(Cam_Item)
        self.splitter.addWidget(Cam_Attrubte))
        # layout = QVBoxLayout(self)
        # layout.addWidget(self.splitter)


        self.Main_Layout.layout().addWidget(Cam_Item)
        self.Main_Layout.layout().addWidget(Cam_Attrubte)
