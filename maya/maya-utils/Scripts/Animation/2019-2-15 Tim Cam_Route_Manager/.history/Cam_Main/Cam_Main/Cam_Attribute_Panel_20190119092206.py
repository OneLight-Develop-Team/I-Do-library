...
class Cam_Attribute_Panel(form_class,base_class):
    ...
    def Check_Selection(self):
        ...
        EXCrv_Check = cmds.objExists(self.Add_Crv_LE.text())
        EXLoc_Check = self.Add_Loc_LE.text() != ""
        EXPath_Check = self.Add_Motion_Path_LE.text() != ""
        EXCam_Base_Cehck = self.MainWindow.Cam_Item_Widget.Attr["Add_Crv_LE"] != ""
