...
class Cam_Attrubte_Panel(form_class,base_class):
    ...
    def Cam_Output_Toggle_Fn(self):
        if self.Cam_Output_Toggle_Check:
            ...
            self.Cam_Output_Toggle.setText(u"▼模板设置")
    ...
    def Templete_Module_Toggle_Fn(self):
        if self.Templete_Module_Toggle_Check:
            self.Templete_Module_Toggle_Check = False
            self.Templete_Module_Toggle_Anim.setDirection(QAbstractAnimation.Forward)
            self.Templete_Module_Toggle_Anim.start()
            self.Templete_Module_Toggle.setText(u"▼模板设置")
            self.Templete_Module_Toggle.setStyleSheet('font:normal')
        else:
            self.Templete_Module_Toggle_Check = True
            self.Templete_Module_Toggle_Anim.setDirection(QAbstractAnimation.Backward)
            self.Templete_Module_Toggle_Anim.start()
            self.Templete_Module_Toggle.setText(u"■模板设置")
            self.Templete_Module_Toggle.setStyleSheet('font:bold')