...
class Cam_Main(form_class,base_class):
    def __init__(self,dock="dock"):
        ...
        Cam_Item_Layout = Cam_Item_Layout()
        Cam_Attrubte_Panel = Cam_Attrubte_Panel()
        self.Main_Layout.layout().addWidget(Cam_Item_Layout)
        self.Main_Layout.layout().addWidget(Cam_Attrubte_Panel)
