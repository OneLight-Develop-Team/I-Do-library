            ...
            if i != 0:
                ...
                if child.geometry().contains(e.pos().x(),e.pos().y()-offset):
                    ...
                    if os.path.exists(GUI_STATE_PATH):
                        ...
                        self.Cam_Attribute_Widget.Add_CamGrp_LE.setText(GUI_STATE['Cam_Item'][CamName]["Attr"]["Add_CamGrp_LE"])
    ...
    def Save_Json_Fun(self,path=GUI_STATE_PATH):
        ...
        for i,child in enumerate(self.Cam_Item_Widget.Item_Layout.children()):
            if i != 0:
                ...
                GUI_STATE['Cam_Item'][CamName]["Attr"]["Add_Motion_Path_Layout"] = child.Attr["Add_Motion_Path_Layout"]
