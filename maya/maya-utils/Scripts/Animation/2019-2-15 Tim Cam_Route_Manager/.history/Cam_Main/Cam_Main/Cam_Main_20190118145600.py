    ...
    def Load_Json_Fun(self,path=GUI_STATE_PATH,load=False):
        if os.path.exists(path):
            ...
            for CamName in GUI_STATE['Cam_Item']:
                ...
                self.Cam_LE.setText("Cam_Item_%s" % parent.Cam_Item_Num)self.Cam_LE.setText("Cam_Item_%s" % parent.Cam_Item_Num)self.Cam_LE.setText("Cam_Item_%s" % parent.Cam_Item_Num)self.Cam_LE.setText("Cam_Item_%s" % parent.Cam_Item_Num)self.Cam_LE.setText("Cam_Item_%s" % parent.Cam_Item_Num)
