    ...
    def Batch_Position_Fn(self):
        ...
        for i,child in enumerate(ChildrenList):
            if i != 0:
                ...
                cmds.setAttr("%s.tx" % CamGrp,1)
                cmds.setAttr("%s.ty" % CamGrp,1)
                cmds.setAttr("%s.tz" % CamGrp,1)
                cmds.setAttr("%s.rx" % CamGrp,1)
                cmds.setAttr("%s.ry" % CamGrp,1)
                cmds.setAttr("%s.rz" % CamGrp,1)
