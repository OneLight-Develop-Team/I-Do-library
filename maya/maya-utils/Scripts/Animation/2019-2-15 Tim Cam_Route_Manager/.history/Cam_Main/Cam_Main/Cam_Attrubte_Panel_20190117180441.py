...
class Cam_Attrubte_Panel(form_class,base_class):
    def __init__(self):
        ...
        self.Templete_Module_Toggle_Anim = QPropertyAnimation(self.Templete_Module_Layout, b"maximumHeight")
        self.Templete_Module_Toggle_Anim.setDuration(300)
        self.Templete_Module_Toggle_Anim.setStartValue(0)
        self.Templete_Module_Toggle_Anim.setEndValue(self.Templete_Module_Layout.sizeHint().height())
        self.Templete_Module_Toggle_Check = False
        self.Templete_Module_Toggle.clicked.connect(self.Templete_Module_Toggle_Fn)
