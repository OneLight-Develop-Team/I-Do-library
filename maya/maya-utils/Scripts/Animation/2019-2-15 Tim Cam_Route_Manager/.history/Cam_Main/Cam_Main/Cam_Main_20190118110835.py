            ...
            if i != 0:
                ...
                if child.geometry().contains(e.pos().x(),e.pos().y()-offset):
                    ...
                    if os.path.exists(GUI_STATE_PATH):
                        ...
                        self.Cam_Attribute_Widget.Strat_Time_SB.setValue(Attr["Strat_Time_SB"])
                        self.Cam_Attribute_Widget.End_Time_SB.setValue(Attr["End_Time_SB"])
