...
class Cam_Attribute_Panel(form_class,base_class):
    ...
    def Check_Selection(self):
        ...
        if Add_Crv_LE_Cehck and Add_Loc_LE_Cehck and Add_Motion_Path_LE_Cehck and Cam_Base_Cehck:
            return True
        else:
            return False
    ...
    def Position_Fn(self):
        if self.Check_Selection():
            ...
            cmds.xform( Selection,cp=1 )
            cmds.delete(cmds.parentConstraint( Base_Curve,self.Add_CamGrp_LE.text() ))
        else:
