...
class Cam_Attribute_Panel(form_class,base_class):
    ...
    def Check_Selection(self):
        ...
        Ex_Loc_Check = cmds.objExists(self.Add_Crv_LE.text())
        Ex_Path_Check = cmds.objExists(self.Add_Crv_LE.text())
        Ex_Cam_Base_Cehck = self.MainWindow.Cam_Item_Widget.Attr["Add_Crv_LE"] != ""
